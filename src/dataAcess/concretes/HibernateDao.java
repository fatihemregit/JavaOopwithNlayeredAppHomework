...
public class HibernateDao  implements DataAcessService {
    ...
    public List<Instructor> getAllInstructor() {
        System.out.println("Hibernate ile instructor listelendi");
        return instructors;
    }
    ...
    public void deleteInstructor(int id) {
        for(Instructor instructor:instructors){
            if(instructor.getId() == id){
                ...
                System.out.println("Hibernate ile instructor silindi");
                return;
            }
        }
    }
